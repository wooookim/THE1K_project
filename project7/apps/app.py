...
# sj 서비스 계정 gcs 연동
# 유출 금지!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
os.environ["GOOGLE_APPLICATION_CREDENTIALS"]="team05-project-ef63902a6756.json"
    ...
    if request.method == 'POST':
        ...
        while(video.isOpened()):
            ...
            if(int(video.get(1)) % fps == 0):
                ...
                gcp_path = "%s_%s" %(id, timestamp)
                
                upload_img_path = "%s/%d/img_%d.jpg" %(gcp_path, time_count, count)
        ...
        return render_template("report.html", concentration_count = concentration_count, F_count = F_count)
